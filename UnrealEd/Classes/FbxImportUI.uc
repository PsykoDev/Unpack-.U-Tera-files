/*******************************************************************************
 * FbxImportUI generated by Eliot.UELib using UE Explorer.
...
enum EFBXImportType<FBXIT_StaticMesh.DisplayName=Static Mesh|FBXIT_SkeletalMesh.DisplayName=Skeletal Mesh>
{
    FBXIT_StaticMesh,
    FBXIT_SkeletalMesh,
    FBXIT_MAX
...
var(General) FbxImportUI.EFBXImportType MeshTypeToImport<DisplayName=Import Type>;
...
defaultproperties
{
    ...
    bSplitNonMatchingTriangles=true
