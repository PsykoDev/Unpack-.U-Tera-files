...
struct native LightmassParameterizedMaterialSettings
{
    ...
    structdefaultproperties
    {
        ...
        EmissiveBoost=(ParameterValue=1.0,bOverride=false)
        DiffuseBoost=(ParameterValue=1.0,bOverride=false)
        SpecularBoost=(ParameterValue=1.0,bOverride=false)
        ExportResolutionScale=(ParameterValue=1.0,bOverride=false)
        DistanceFieldPenumbraScale=(ParameterValue=1.0,bOverride=false)
    }
};
