...
struct native TakeHitInfo
{
    ...
    structdefaultproperties
    {
        ...
        Damage=0.0
        RadialDamageOrigin=(X=0.0,Y=0.0,Z=0.0)
    }
};
...
struct native CrowdSpawnerPlayerInfo
{
    ...
    structdefaultproperties
    {
        ...
        PredictLocation=(X=0.0,Y=0.0,Z=0.0)
        PC=none
    }
};
...
struct native CrowdSpawnInfoItem
{
    ...
    structdefaultproperties
    {
        ...
        AgentFrequencySum=0.0
        MaxSpawnDist=0.0
        MaxSpawnDistSq=0.0
        MinBehindSpawnDist=0.0
        MinBehindSpawnDistSq=0.0
        AgentWarmupTime=3.0
