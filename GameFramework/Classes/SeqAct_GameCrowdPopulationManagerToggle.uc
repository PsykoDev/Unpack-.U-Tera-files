...
event FillCrowdSpawnInfoItem(out CrowdSpawnInfoItem out_Item, GameCrowdPopulationManager PopMgr)
{
    ...
    out_Item.MinBehindSpawnDist = FMin(MinBehindSpawnDist, out_Item.MaxSpawnDist * 0.06250);
...
defaultproperties
{
    ...
    InputLinks(2)=(LinkDesc="Warmup",bHasImpulse=false,QueuedActivations=0,bDisabled=false,bDisabledPIE=false,LinkedOp=none,DrawY=0,bHidden=false,ActivateDelay=0.0,bMoving=false,bClampedMax=false,bClampedMin=false,OverrideDelta=0)
    InputLinks(3)=(LinkDesc="Kill Agents",bHasImpulse=false,QueuedActivations=0,bDisabled=false,bDisabledPIE=false,LinkedOp=none,DrawY=0,bHidden=false,ActivateDelay=0.0,bMoving=false,bClampedMax=false,bClampedMin=false,OverrideDelta=0)
    InputLinks(4)=(LinkDesc="Stop & Kill",bHasImpulse=false,QueuedActivations=0,bDisabled=false,bDisabledPIE=false,LinkedOp=none,DrawY=0,bHidden=false,ActivateDelay=0.0,bMoving=false,bClampedMax=false,bClampedMin=false,OverrideDelta=0)
