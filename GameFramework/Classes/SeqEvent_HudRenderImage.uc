...
function Render(Canvas TargetCanvas, HUD TargetHud)
{
    ...
    if(bIsActive)
    {
        ...
        UsedXL = ((XL <= 1.0) ? XL * float(TargetCanvas.SizeX) : XL * GlobalScaleX);
        UsedYL = ((YL <= 1.0) ? YL * float(TargetCanvas.SizeX) : YL * GlobalScaleY);
...
defaultproperties
{
    DisplayColor=(R=0.0,G=0.0,B=0.0,A=1.0)
