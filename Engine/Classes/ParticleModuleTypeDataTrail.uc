...
defaultproperties
{
    ...
    Tension=Distribution=DistributionFloatConstant'Default__ParticleModuleTypeDataTrail.DistributionTension',Type=0,Op=1,LookupTableNumElements=1,LookupTableChunkSize=1,LookupTable=/* Array type was not detected. */,
