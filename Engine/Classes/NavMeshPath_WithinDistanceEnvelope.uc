/*******************************************************************************
 * NavMeshPath_WithinDistanceEnvelope generated by Eliot.UELib using UE Explorer.
...
static function bool StayWithinEnvelopeToLoc(NavigationHandle NavHandle, Vector InEnvelopeTestPoint, float InMaxDistance, float InMinDistance, optional bool bInSoft, optional float InSoftStartPenalty, optional bool bOnlyTossOutSpecsThatLeave)
{
    local NavMeshPath_WithinDistanceEnvelope Con;

    bInSoft = true;
    InSoftStartPenalty = -1.0;    
    // End:0x199
    if(NavHandle != none)
    {
