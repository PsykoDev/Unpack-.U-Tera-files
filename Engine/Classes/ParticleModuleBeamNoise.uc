...
Parameter name: index
   ...
   at UELib.Core.UDefaultProperty.DeserializeDefaultPropertyValue(PropertyType type, DeserializeFlags& deserializeFlags) */
    NoiseTessellation=1
    NoiseScale=Distribution=DistributionFloatConstantCurve'Default__ParticleModuleBeamNoise.DistributionNoiseScale',Type=0,Op=1,LookupTableNumElements=1,LookupTableChunkSize=1,LookupTable=/* Array type was not detected. */,
