...
struct native SkeletalMeshOptimizationSettings
{
    ...
    structdefaultproperties
    {
        ...
        BoneReductionRatio=0.0
        MaxBonesPerVertex=0
        ReductionMethod=SkeletalMeshOptimizationType.SMOT_NumOfTriangles
        NumOfTrianglesPercentage=0.0
        WeldingThreshold=0.0
        bRecalcNormals=false
        NormalsThreshold=0.0
    }
};
...
defaultproperties
{
    ...
    ClothPressure=1.0
    ClothCollisionResponseCoefficient=0.20
    ClothAttachmentResponseCoefficient=0.20
    ClothAttachmentTearFactor=1.50
    ClothSleepLinearVelocity=-1.0
    HardStretchLimitFactor=1.10
    ClothMetalImpulseThreshold=10.0
    ClothTearFactor=3.50
    ClothTearReserve=128
    SoftBodyVolumeStiffness=1.0
    SoftBodyStretchingStiffness=1.0
    SoftBodyDensity=1.0
    SoftBodyParticleRadius=0.10
    SoftBodyDamping=0.50
    SoftBodySolverIterations=5
    SoftBodyFriction=0.50
    SoftBodyRelativeGridSpacing=1.0
    SoftBodySleepLinearVelocity=-1.0
    SoftBodyAttachmentResponse=0.20
    SoftBodyCollisionResponse=0.20
    SoftBodyDetailLevel=0.50
    SoftBodySubdivisionLevel=4
    bSoftBodyIsoSurface=true
    SoftBodyAttachmentThreshold=0.50
    bEnableSoftBodyTwoWayCollision=true
    SoftBodyAttachmentTearFactor=1.50
