...
var deprecated ParticleEmitter.EEmitterRenderMode EmitterRenderMode;
...
/** Translate emitter in world coord (only for sprite emitter) */
var(Translation) Vector Translation;
/** Rotate emitter in world coord (only for sprite emitter) */
var(Rotation) Rotator Rotation;
...
defaultproperties
{
    ...
    EmitterDuration=1.0
    EmitterLoops=1
    SpawnRate=Distribution=DistributionFloatConstant'Default__ParticleModuleRequired.RequiredDistributionSpawnRate',Type=0,Op=1,LookupTableNumElements=1,LookupTableChunkSize=1,LookupTable=/* Array type was not detected. */,
