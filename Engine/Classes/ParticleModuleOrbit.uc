...
defaultproperties
{
    ...
    OffsetAmount=Distribution=DistributionVectorUniform'Default__ParticleModuleOrbit.DistributionOffsetAmount',Type=0,Op=2,LookupTableNumElements=2,LookupTableChunkSize=6,LookupTable=/* Array type was not detected. */,
...
System.ArgumentException: Requested value '*' was not found.
   ...
   at UELib.Core.UDefaultProperty.DeserializeDefaultPropertyValue(PropertyType type, DeserializeFlags& deserializeFlags) */
    ...
    RotationAmount=Distribution=DistributionVectorUniform'Default__ParticleModuleOrbit.DistributionRotationAmount',Type=0,Op=2,LookupTableNumElements=2,LookupTableChunkSize=6,LookupTable=/* Array type was not detected. */,
...
System.ArgumentException: Requested value '*' was not found.
   ...
   at UELib.Core.UDefaultProperty.DeserializeDefaultPropertyValue(PropertyType type, DeserializeFlags& deserializeFlags) */
    ...
    RotationRateAmount=Distribution=DistributionVectorUniform'Default__ParticleModuleOrbit.DistributionRotationRateAmount',Type=0,Op=2,LookupTableNumElements=2,LookupTableChunkSize=6,LookupTable=/* Array type was not detected. */,
