...
struct native SoundModeData
{
    var Double SoundModeStartTime;
    var Double SoundModeEndTime;
    var SoundMode SoundMode;

    structdefaultproperties
    {
        SoundModeStartTime=none
        SoundModeEndTime=none
        SoundMode=none
    }
};
...
var transient array<SoundModeData> SoundModeQueue;
...
// Export UAudioDevice::execPendingSoundMode(FFrame&, void* const)
native final function PendingSoundMode(SoundModeData ModeData);

// Export UAudioDevice::execQueueSoundMode(FFrame&, void* const)
native final function QueueSoundMode(name ModeName);
