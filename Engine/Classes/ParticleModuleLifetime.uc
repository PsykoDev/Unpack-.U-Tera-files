...
defaultproperties
{
    Lifetime=Distribution=DistributionFloatUniform'Default__ParticleModuleLifetime.DistributionLifetime',Type=0,Op=1,LookupTableNumElements=1,LookupTableChunkSize=1,LookupTable=/* Array type was not detected. */,
