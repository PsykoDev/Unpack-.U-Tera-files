...
defaultproperties
{
    RotRate=Distribution=DistributionVectorConstantCurve'Default__ParticleModuleMeshRotationRateOverLife.DistributionRotRate',Type=0,Op=1,LookupTableNumElements=1,LookupTableChunkSize=3,LookupTable=/* Array type was not detected. */,
