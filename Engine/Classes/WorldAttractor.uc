...
{
    bEnabled=true
    FalloffExponent=(MatineeValue=0.0,bInMatinee=false,Distribution=DistributionFloatConstant'Default__WorldAttractor.DistributionFalloffExponent',Type=0,Op=0,LookupTableNumElements=0,LookupTableChunkSize=0,LookupTable=none,LookupTableTimeScale=0.0,LookupTableStartTime=0.0)
    Range=(MatineeValue=0.0,bInMatinee=false,Distribution=DistributionFloatConstant'Default__WorldAttractor.DistributionRange',Type=0,Op=0,LookupTableNumElements=0,LookupTableChunkSize=0,LookupTable=none,LookupTableTimeScale=0.0,LookupTableStartTime=0.0)
    Strength=(MatineeValue=0.0,bInMatinee=false,Distribution=DistributionFloatConstant'Default__WorldAttractor.DistributionStrength',Type=0,Op=0,LookupTableNumElements=0,LookupTableChunkSize=0,LookupTable=none,LookupTableTimeScale=0.0,LookupTableStartTime=0.0)
    DragCoefficient=(MatineeValue=0.0,bInMatinee=false,Distribution=DistributionFloatConstant'Default__WorldAttractor.DistributionDragCoefficient',Type=0,Op=0,LookupTableNumElements=0,LookupTableChunkSize=0,LookupTable=none,LookupTableTimeScale=0.0,LookupTableStartTime=0.0)
    DragRadius=(MatineeValue=0.0,bInMatinee=false,Distribution=DistributionFloatConstant'Default__WorldAttractor.DistributionDragRadius',Type=0,Op=0,LookupTableNumElements=0,LookupTableChunkSize=0,LookupTable=none,LookupTableTimeScale=0.0,LookupTableStartTime=0.0)
