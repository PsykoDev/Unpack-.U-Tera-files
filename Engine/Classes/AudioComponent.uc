...
/** WITH_S1ducklmg 2008.12.3 : Attenuation ??? AudioComponent ??? ?? */
var() float RadiusMultiplier;
...
native final function Play(optional float fStartTime)
{
    fStartTime = 0.0;            
}
...
{
    VolumeMultiplier *= ((bNowOccluded) ? 0.50 : 2.0);
    //return;    
}
