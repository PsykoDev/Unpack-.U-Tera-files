...
// Export UTexture2D::execLoadTextureResources(FFrame&, void* const)
native static final function int LoadTextureResources(const out array<Texture> ListOfTexturesToLoad);

// Export UTexture2D::execUnloadTextureResources(FFrame&, void* const)
native static final function int UnloadTextureResources(const out array<Texture> ListOfTexturesToUnload);

// Export UTexture2D::execGetBytesUsedForTextureResources(FFrame&, void* const)
native static final function int GetBytesUsedForTextureResources(const out array<Texture> ListOfTextures);

// Export UTexture2D::execCreateListOfTexturesToUnload(FFrame&, void* const)
native static final function int CreateListOfTexturesToUnload(int TotalBytesNeeded, out array<Texture> ListOfTexturesToUnload, optional out array<Texture> ListOfTexturesToAvoid, const optional out array<Texture.TextureGroup> OnlyUseTheseTextureGroups);
