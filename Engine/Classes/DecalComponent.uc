...
/** @HSL_BEGIN_PS4 - TODO - Orbis has a different depth bias. We need a cleaner solution for this. */
...
defaultproperties
{
    ...
    DepthBias=-0.000060
    OrbisDepthBias=-1.60
    OrbisSlopeScaleDepthBias=50.0
    BackfaceAngle=0.0010
    BlendRange=(X=89.50,Y=180.0)
