/*******************************************************************************
 * AnimNodeAdditiveBlending generated by Eliot.UELib using UE Explorer.
...
defaultproperties
{
    ...
    Children(0)=(Name=Base Anim Input,Anim=none,Weight=1.0,BlendWeight=0.0,bMirrorSkeleton=false,bIsAdditive=false,DrawY=0)
    Children(1)=(Name=Additive Anim Input,Anim=none,Weight=1.0,BlendWeight=0.0,bMirrorSkeleton=false,bIsAdditive=false,DrawY=0)
