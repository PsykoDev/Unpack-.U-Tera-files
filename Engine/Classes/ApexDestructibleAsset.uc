...
struct native NxDestructibleDebrisParameters
{
    ...
    structdefaultproperties
    {
        ...
        ValidBounds=(Min=(X=-500000.0,Y=-500000.0,Z=-500000.0),Max=(X=500000.0,Y=500000.0,Z=500000.0),IsValid=0)
    }
};
...
struct native NxDestructibleParameters
{
    ...
    structdefaultproperties
    {
        DamageParameters=(DamageThreshold=0.0,DamageSpread=0.0,ImpactDamage=0.0,ImpactResistance=0.0,DefaultImpactDamageDepth=-1)
        DebrisParameters=(DebrisLifetimeMin=0.0,DebrisLifetimeMax=0.0,DebrisMaxSeparationMin=0.0,DebrisMaxSeparationMax=0.0,ValidBounds=(Min=(X=-500000.0,Y=-500000.0,Z=-500000.0),Max=(X=500000.0,Y=500000.0,Z=500000.0),IsValid=0))
        AdvancedParameters=(DamageCap=0.0,ImpactVelocityThreshold=0.0,MaxChunkSpeed=0.0,MassScaleExponent=0.0,MassScale=0.0,FractureImpulseScale=0.0)
        SupportDepth=0
