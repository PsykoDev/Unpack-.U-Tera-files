...
struct native ROscillator
{
    ...
    structdefaultproperties
    {
        Pitch=(Amplitude=0.0,Frequency=0.0,InitialOffset=EInitialOscillatorOffset.EOO_OffsetRandom)
        Yaw=(Amplitude=0.0,Frequency=0.0,InitialOffset=EInitialOscillatorOffset.EOO_OffsetRandom)
        Roll=(Amplitude=0.0,Frequency=0.0,InitialOffset=EInitialOscillatorOffset.EOO_OffsetRandom)
    }
};
...
struct native VOscillator
{
    ...
    structdefaultproperties
    {
        X=(Amplitude=0.0,Frequency=0.0,InitialOffset=EInitialOscillatorOffset.EOO_OffsetRandom)
        Y=(Amplitude=0.0,Frequency=0.0,InitialOffset=EInitialOscillatorOffset.EOO_OffsetRandom)
        Z=(Amplitude=0.0,Frequency=0.0,InitialOffset=EInitialOscillatorOffset.EOO_OffsetRandom)
    }
};
...
defaultproperties
{
    OscillationBlendInTime=0.10
    OscillationBlendOutTime=0.20
    AnimPlayRate=1.0
    AnimScale=1.0
    AnimBlendInTime=0.20
    AnimBlendOutTime=0.20
}