...
struct InteriorSettings
{
    ...
    structdefaultproperties
    {
        ...
        ExteriorTime=0.50
        ExteriorLPF=1.0
        ExteriorLPFTime=0.50
        InteriorVolume=1.0
        InteriorTime=0.50
        InteriorLPF=1.0
        InteriorLPFTime=0.50
    }
};
...
{
    bEnabled=true
    Settings=(bApplyReverb=true,ReverbType=ReverbPreset.REVERB_Default,Volume=0.50,FadeTime=2.0)
    AmbientZoneSettings=(bIsWorldInfo=false,ExteriorVolume=1.0,ExteriorTime=0.50,ExteriorLPF=1.0,ExteriorLPFTime=0.50,InteriorVolume=1.0,InteriorTime=0.50,InteriorLPF=1.0,InteriorLPFTime=0.50)
