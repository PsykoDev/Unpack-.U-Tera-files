...
struct native PlatformInterfaceDelegateResult
{
    ...
    {
        bSuccessful=false
        Data=(DataName=None,Type=EPlatformInterfaceDataType.PIDT_None,IntValue=0,FloatValue=0.0,StringValue="",StringValue2="",ObjectValue=none)
    }
};
...
// Export UPlatformInterfaceBase::execGetGoogleIntegration(FFrame&, void* const)
