...
struct native PBScope2D
{
    ...
    {
        ScopeFrame=(XPlane=(X=0.0,Y=0.0,Z=0.0,W=0.0),YPlane=(X=0.0,Y=0.0,Z=0.0,W=0.0),ZPlane=(X=0.0,Y=0.0,Z=0.0,W=0.0),WPlane=(X=0.0,Y=0.0,Z=0.0,W=0.0))
        DimX=0.0
        DimZ=0.0
    }
};
...
struct native PBEdgeInfo
{
    ...
    structdefaultproperties
    {
        EdgeEnd=(X=0.0,Y=0.0,Z=0.0)
        EdgeStart=(X=0.0,Y=0.0,Z=0.0)
        ScopeAIndex=0
