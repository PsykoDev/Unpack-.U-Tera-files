...
defaultproperties
{
    PartialOccludedBuildingMesh=(Mesh=none,DimX=512.0,DimZ=512.0,Chance=1.0,Translation=none,Rotation=none,bMeshScaleTranslation=false,bOverrideMeshLightMapRes=false,OverriddenMeshLightMapRes=32,MaterialOverrides=none,SectionOverrides=none)
