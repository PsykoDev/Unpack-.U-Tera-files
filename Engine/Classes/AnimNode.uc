...
var(Morph) editoronly transient array<editoronly CurveKey> LastUpdatedAnimMorphKeys;
...
defaultproperties
{
    CachedRootMotionDelta=(Rotation=(X=0.0,Y=0.0,Z=0.0,W=0.0),Translation=(X=0.0,Y=0.0,Z=0.0),Scale=0.0,Scale3D=(X=1.0,Y=1.0,Z=1.0,W=1.0))
}