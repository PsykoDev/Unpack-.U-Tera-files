...
var bool bAlwaysRetainLowLODLevel;
var bool bHideWithSkeleton;
var bool bWarmingUp;
var bool bPreferHigherClientLOD;
...
var transient bool bAttachLightEnvToOwner;
/**  
...
var export editinline transient StaticMeshComponent HitComponent;
...
var native transient Pointer mCachedTemplate;
var transient Double mPreTickTime;
var transient int mTotalActiveParticles;
...
// Export UParticleSystemComponent::execSetClientLODLevel(FFrame&, void* const)
native final function SetClientLODLevel(int InLODLevel);

// Export UParticleSystemComponent::execGetClientLODLevel(FFrame&, void* const)
native final function int GetClientLODLevel();
