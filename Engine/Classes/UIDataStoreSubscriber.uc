/*******************************************************************************
 * UIDataStoreSubscriber generated by Eliot.UELib using UE Explorer.
...
native function SetDataStoreBinding(string MarkupText, optional int BindingIndex)
{
    BindingIndex = -1;                
}

// Export UUIDataStoreSubscriber::execGetDataStoreBinding(FFrame&, void* const)
native function string GetDataStoreBinding(optional int BindingIndex)
{
    BindingIndex = -1;            
}

// Export UUIDataStoreSubscriber::execRefreshSubscriberValue(FFrame&, void* const)
native function bool RefreshSubscriberValue(optional int BindingIndex)
{
    BindingIndex = -1;            
}
