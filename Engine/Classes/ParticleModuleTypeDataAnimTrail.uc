/*******************************************************************************
 * ParticleModuleTypeDataAnimTrail generated by Eliot.UELib using UE Explorer.
...
var(Trail) bool bSpreadTriangle;
var(Trail) bool bApplyFirstAnimTrailDataParameter;
...
/** #if WITH_S1-ponti ParticleAnimTrail */
var(Trail) float TickInterval;
var(Trail) float Duration;
var(Trail) float OriginMove;
var(Trail) float Length;
var(Trail) float MinOriginDistance;
/**  
