...
defaultproperties
{
    SubImageIndex=Distribution=DistributionFloatConstant'Default__ParticleModuleSubUV.DistributionSubImage',Type=0,Op=1,LookupTableNumElements=1,LookupTableChunkSize=1,LookupTable=/* Array type was not detected. */,
