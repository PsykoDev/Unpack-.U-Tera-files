/*******************************************************************************
 * ParticleModuleTypeDataMesh generated by Eliot.UELib using UE Explorer.
...
/** Translation of Particle Data Mesh */
var(Mesh) RawDistributionVector Translation;
/** Rotation of Particle Data Mesh */
var(Mesh) RawDistributionVector Rotation;
/** Velocity for world Translation */
var(Mesh) RawDistributionVector Velocity;
/** Acceleration for world Translation */
var(Mesh) RawDistributionVector Acceleration;

defaultproperties
{
    Translation=Distribution=DistributionVectorConstant'Default__ParticleModuleTypeDataMesh.DistributionTranslation',Type=0,Op=1,LookupTableNumElements=1,LookupTableChunkSize=3,LookupTable=/* Array type was not detected. */,
/* Exception thrown while deserializing Translation
System.ArgumentException: Requested value '*' was not found.
   at System.Enum.TryParseEnum(Type enumType, String value, Boolean ignoreCase, EnumResult& parseResult)
   at System.Enum.Parse(Type enumType, String value, Boolean ignoreCase)
   at UELib.Core.UDefaultProperty.Deserialize()
   at UELib.Core.UDefaultProperty.DeserializeDefaultPropertyValue(PropertyType type, DeserializeFlags& deserializeFlags) */
    Rotation=Distribution=DistributionVectorConstant'Default__ParticleModuleTypeDataMesh.DistributionRotation',Type=0,Op=1,LookupTableNumElements=1,LookupTableChunkSize=3,LookupTable=/* Array type was not detected. */,
/* Exception thrown while deserializing Rotation
System.ArgumentException: Requested value '*' was not found.
   at System.Enum.TryParseEnum(Type enumType, String value, Boolean ignoreCase, EnumResult& parseResult)
   at System.Enum.Parse(Type enumType, String value, Boolean ignoreCase)
   at UELib.Core.UDefaultProperty.Deserialize()
   at UELib.Core.UDefaultProperty.DeserializeDefaultPropertyValue(PropertyType type, DeserializeFlags& deserializeFlags) */
    Velocity=Distribution=DistributionVectorConstant'Default__ParticleModuleTypeDataMesh.DistributionVelocity',Type=0,Op=1,LookupTableNumElements=1,LookupTableChunkSize=3,LookupTable=/* Array type was not detected. */,
...
System.ArgumentException: Requested value '*' was not found.
   ...
   at UELib.Core.UDefaultProperty.Deserialize()
   at UELib.Core.UDefaultProperty.DeserializeDefaultPropertyValue(PropertyType type, DeserializeFlags& deserializeFlags) */
    Acceleration=Distribution=DistributionVectorConstant'Default__ParticleModuleTypeDataMesh.DistributionAcceleration',Type=0,Op=1,LookupTableNumElements=1,LookupTableChunkSize=3,LookupTable=/* Array type was not detected. */,
