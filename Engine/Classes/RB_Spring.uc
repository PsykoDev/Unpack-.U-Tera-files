...
defaultproperties
{
    SpringMaxForceTimeScale=(Points=/* Array type was not detected. */,InVal=0.0,OutVal=1.0,ArriveTangent=0.0,LeaveTangent=0.0,InterpMode=EInterpCurveMode.CIM_Linear)
