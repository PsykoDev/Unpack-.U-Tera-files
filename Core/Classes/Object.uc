...
struct dword
{
    /** @HSL_BEGIN_PS4 - ccooper 7/17/2015 - Adding DWORD as a temporary script->c++ mirror */
    var() native int A;
};
...
struct SHVectorRGB
{
    ...
    structdefaultproperties
    {
        R=(V=0.0,V[1]=0.0,V[2]=0.0,V[3]=0.0,V[4]=0.0,V[5]=0.0,V[6]=0.0,V[7]=0.0,V[8]=0.0,Padding=0.0,Padding[1]=0.0,Padding[2]=0.0)
        G=(V=0.0,V[1]=0.0,V[2]=0.0,V[3]=0.0,V[4]=0.0,V[5]=0.0,V[6]=0.0,V[7]=0.0,V[8]=0.0,Padding=0.0,Padding[1]=0.0,Padding[2]=0.0)
        B=(V=0.0,V[1]=0.0,V[2]=0.0,V[3]=0.0,V[4]=0.0,V[5]=0.0,V[6]=0.0,V[7]=0.0,V[8]=0.0,Padding=0.0,Padding[1]=0.0,Padding[2]=0.0)
    }
};
...
struct atomic immutable Matrix
{
    ...
    structdefaultproperties
    {
        XPlane=(X=0.0,Y=0.0,Z=0.0,W=0.0)
        YPlane=(X=0.0,Y=0.0,Z=0.0,W=0.0)
        ZPlane=(X=0.0,Y=0.0,Z=0.0,W=0.0)
        WPlane=(X=0.0,Y=0.0,Z=0.0,W=0.0)
    }
};
...
struct InterpCurvePointVector2D
{
    ...
    structdefaultproperties
    {
        InVal=0.0
        OutVal=(X=0.0,Y=0.0)
        ArriveTangent=(X=0.0,Y=0.0)
        LeaveTangent=(X=0.0,Y=0.0)
        InterpMode=EInterpCurveMode.CIM_Linear
    }
};
...
struct InterpCurvePointVector
{
    ...
    {
        InVal=0.0
        OutVal=(X=0.0,Y=0.0,Z=0.0)
        ArriveTangent=(X=0.0,Y=0.0,Z=0.0)
        LeaveTangent=(X=0.0,Y=0.0,Z=0.0)
        InterpMode=EInterpCurveMode.CIM_Linear
    }
};
...
struct InterpCurvePointTwoVectors
{
    ...
    {
        InVal=0.0
        OutVal=(v1=(X=0.0,Y=0.0,Z=0.0),v2=(X=0.0,Y=0.0,Z=0.0))
        ArriveTangent=(v1=(X=0.0,Y=0.0,Z=0.0),v2=(X=0.0,Y=0.0,Z=0.0))
        LeaveTangent=(v1=(X=0.0,Y=0.0,Z=0.0),v2=(X=0.0,Y=0.0,Z=0.0))
        InterpMode=EInterpCurveMode.CIM_Linear
    }
};
...
struct InterpCurvePointQuat
{
    ...
    {
        InVal=0.0
        OutVal=(X=0.0,Y=0.0,Z=0.0,W=0.0)
        ArriveTangent=(X=0.0,Y=0.0,Z=0.0,W=0.0)
        LeaveTangent=(X=0.0,Y=0.0,Z=0.0,W=0.0)
        InterpMode=EInterpCurveMode.CIM_Linear
    }
};
...
struct InterpCurvePointLinearColor
{
    ...
    {
        InVal=0.0
        OutVal=(R=0.0,G=0.0,B=0.0,A=1.0)
        ArriveTangent=(R=0.0,G=0.0,B=0.0,A=1.0)
        LeaveTangent=(R=0.0,G=0.0,B=0.0,A=1.0)
        InterpMode=EInterpCurveMode.CIM_Linear
    }
};
...
struct BoneAtom
{
    ...
    structdefaultproperties
    {
        ...
        Scale=0.0
        Scale3D=(X=0.0,Y=0.0,Z=0.0,W=0.0)
    }
};
...
// Export UObject::execEnumFromString(FFrame&, void* const)
...
{
    OutFOV.X = OutFOV.X * 57.295780;
    OutFOV.Y = OutFOV.Y * 57.295780;
    //return;    
}
